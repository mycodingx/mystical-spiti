    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .label {
            ...
            align-items: center;
            gap: 6px;
            background: rgba(201, 83, 26, 0.12);
            border: 1px solid rgba(201, 83, 26, 0.3);
            color: #f4a87a;
            font-size: 12px;
            font-weight: 600;
    ...
    <div class="wrap">
        <div class="card">
            <svg class="mountain" viewBox="0 0 600 80" width="200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <polygon points="0,80 120,10 200,45 300,0 400,35 480,15 600,80" fill="#c9531a"/>
            </svg>
            <div class="code">404</div>
            <div class="label"><i class="fa-solid fa-mountain"></i> Trail Not Found</div>
            <h1>Lost in the Mountains?</h1>
            <p>This path doesn't exist in Spiti Valley — or it may have been moved.<br>
